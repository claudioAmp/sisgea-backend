...
public class ATMRedAsociadaService extends MantenibleService<ATMRedAsociada> implements IATMRedAsociadaService {
    ...
    private static final String ATM_RED_ASOCIADA_NO_ENCONTRADO = "El ATM red asociada %d asociado a la " +
            "institución %d no fue encontrado";

    private final IATMRedAsociadaMapper atmRedAsociadaMapper;

    public ATMRedAsociadaService(@Qualifier("IATMRedAsociadaMapper") IMantenibleMapper<ATMRedAsociada> mantenibleMapper) {
