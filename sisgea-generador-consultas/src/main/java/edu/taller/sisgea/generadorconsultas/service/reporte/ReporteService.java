...
import edu.taller.sisgea.generadorconsultas.mapper.IReporteMapper;
import edu.taller.sisgea.generadorconsultas.model.criterio.paginacion.PageParameter;
import edu.taller.sisgea.generadorconsultas.service.condicionquery.ICondicionQueryService;
import edu.taller.sisgea.generadorconsultas.service.filtro.IFiltroService;
import edu.taller.sisgea.generadorconsultas.service.generarconsulta.IGenerarConsultaService;
import edu.taller.sisgea.generadorconsultas.service.reporteprioridad.IReportePrioridadService;
import edu.taller.sisgea.generadorconsultas.service.tablaonjoin.ITablaOnJoinService;
...
import edu.taller.sisgea.generadorconsultas.service.campoquery.ICampoQueryService;
...
public class ReporteService extends MantenibleService<Reporte> implements IReporteService {
	...
	private @Autowired
    IReportePrioridadService reportePrioridadService;
	private @Autowired ITablaQueryService tablaQueryService;
	private @Autowired
    ITablaOnJoinService tablaOnJoinService;
	private @Autowired ICampoQueryService campoQueryService;
	private @Autowired
    IFiltroService filtroService;
	private @Autowired
    ICondicionQueryService condicionService;
	private @Autowired
    IUltimoSecuenciaService ultimoSecuenciaService;
	private @Autowired
    IGenerarConsultaService generarConsultaService;
