package edu.taller.sisgea.consultasgenerales.controller.solicitud.advice;
...
public class AdviceConsultaGeneralRestController {
	
	private static final Logger logger = LoggerFactory.getLogger(AdviceConsultaGeneralRestController.class);
