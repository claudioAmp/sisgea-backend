package edu.taller.sisgea.consultasgenerales.model.criterio.dcioutdiners;
...
@NoArgsConstructor
@AllArgsConstructor
public class CriterioBusquedaDcioutCharge {
